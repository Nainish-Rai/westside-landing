...
const Footer = ({
  ...
  description = "Complete end-to-end solution for your business needs.",
  socialLinks = defaultSocialLinks,
  copyright = "© 2025 WestSide All rights reserved.",
        ...
        <div className="flex px-16 w-full flex-col justify-between gap-10 lg:flex-row lg:items-start lg:text-left">
          <div className="flex w-full flex-col justify-between gap-6 lg:items-start">
            ...
            <div className="flex items-center gap-2 lg:justify-start">
              ...
              <h2 className="text-xl font-semibold">West Side</h2>
            </div>
